...
do
	filename=results/all_raw_N_0_0_${run}.out
	sudo ../kvell/main 0 2 4 a > ${filename} 2>&1
done
...
for run in 0 1 2 3 4
do
	filename=results/all_raw_Y_32_15_${run}.out
	sudo ../kvell/main 0 2 4 a > ${filename} 2>&1
done
...
for run in 0 1 2 3 4
do
	filename=results/all_raw_N_32_15_${run}.out
	sudo ../kvell/main 0 2 4 a > ${filename} 2>&1
done
