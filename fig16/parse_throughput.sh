...
paste default.thru.out.0.tmp default.thru.out.1.tmp default.thru.out.2.tmp default.thru.out.3.tmp default.thru.out.4.tmp | awk '{print ($1+$2+$4+$4+$5)/5}' >> default.thru.out.tmp
...
paste cint.thru.out.0.tmp cint.thru.out.1.tmp cint.thru.out.2.tmp cint.thru.out.3.tmp cint.thru.out.4.tmp | awk '{print ($1+$2+$4+$4+$5)/5}' >> cint.thru.out.tmp
...
paste adaptive.thru.out.0.tmp adaptive.thru.out.1.tmp adaptive.thru.out.2.tmp adaptive.thru.out.3.tmp adaptive.thru.out.4.tmp | awk '{print ($1+$2+$4+$4+$5)/5}' >> adaptive.thru.out.tmp
