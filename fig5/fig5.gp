...
ysiz = .205;  # y size of each subfig
xoff = .0;  # push all subfigs to right by xoff to make room for joint ylabel
...
# line=1
i=1  ; arYhi[i]=450; arYtic[i]=150;  arTitle[i]="total IOPS\n"."[1000s]";
i=i+1; arYhi[i]=450; arYtic[i]=150;  arTitle[i]="sync IOPS\n"."[1000s]";
i=i+1; arYhi[i]= 75; arYtic[i]= 25;  arTitle[i]="sync latency\n[{/Symbol m}sec]";
